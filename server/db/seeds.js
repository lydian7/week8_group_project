...
db.facts.insertMany ([
    {
        ...
        "Pop music is music that is commercially recorded for a youthful audience and is much distinguishable from jazz and folk music."
    ...
    {
        genre: "11",
        facts: ["Indian Classical Music And Jazz Have A Lot In Common.The renowned sitar player, Ravi Shankar, had quite an influence on John McLaughlin.",
         "Jazz is “a means to develop and increase intercultural exchanges & understanding between cultures for the purpose of mutual comprehension & tolerance”.",
        "The first truly successful US jazz group called itself The Original Dixieland Jass Band.",
